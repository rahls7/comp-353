...
class InstrumentsController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update', 'instruments', 'instrumentswithprices', 'instrumentCurrency'),
				'users'=>array('@'),
			),
    ...
    public function actionInstrumentCurrency($id)
	{
	...
	{
		$dataProvider=new CActiveDataProvider('Instruments');
	 ...
	 * @param Instruments $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='instruments-form')
		{
