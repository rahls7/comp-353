 ...
 * @property string $upload_description
 */
class Uploads extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, user_id, upload_date, upload_file, instrument_id, upload_description', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'upload_description' => 'Short Description',
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('upload_description',$this->upload_description,true);
